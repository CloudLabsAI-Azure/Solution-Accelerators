...
(Get-Content -Path "C:\LabFiles\logon.ps1") | ForEach-Object {$_ -Replace 'enter_user_name', $userName} | Set-Content -Path "C:\LabFiles\logontask.ps1"
(Get-Content -Path "C:\LabFiles\logon.ps1") | ForEach-Object {$_ -Replace 'enter_password', $password} | Set-Content -Path "C:\LabFiles\logontask.ps1"
